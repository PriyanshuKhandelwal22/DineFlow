...
## 🔐 Staff Portals & Credentials

DineFlow enforces role-based dashboard protection. You must authenticate to access the respective views.

### How to Access the Portals
*   **Login Page**: Navigate to `/login`.
*   **Admin Panel**: Navigate to `/admin`. If you are not authenticated, you will be redirected to the login page.
*   **Kitchen Display System (KDS)**: Navigate to `/kds`. Unauthenticated users will be redirected to the login page.

### Default Seeded Accounts
You can log in to these portals using the credentials generated by the seeding script:

#### 1. Administrator Dashboard (`/admin`)
*   **Email**: `admin@menuverse.com`
*   **Password**: `admin123`
*   **Role**: `ADMIN` (Grants access to `/admin` dashboard modules and `/kds`)

#### 2. Kitchen Display System (`/kds`)
*   **Email**: `kitchen@menuverse.com`
*   **Password**: `kitchen123`
*   **Role**: `KITCHEN` (Grants access **only** to `/kds`. Any attempt to access `/admin` will be redirected back to the kitchen display.)
